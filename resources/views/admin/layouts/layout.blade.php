        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('assets/admin/img/foto.jpg') }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Simon</a>
                    </div>
                </div>
    ...
    <script>
        ClassicEditor
            ...
            .catch(error => {
                ...
                console.warn('Build id: sugulwqkme47-o8tzu0s7w3pq');
                console.error(error);
            });
        ...
        ClassicEditor
            ...
            ClassicEditor
            .create(document.querySelector("#applications"), {
